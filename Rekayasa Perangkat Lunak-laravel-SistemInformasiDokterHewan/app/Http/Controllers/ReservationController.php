...
class ReservationController extends Controller
{
    ...
    {
        $list = Service::select('id','name','price')->get();
        return view('reservations.list', compact('list'));
    }


    public function about()
    {
        return view('reservations.about');
    }


    // public function aboutlaadmin()
    // {
    //     return view('reservations.aboutlaadmin');
    // }
